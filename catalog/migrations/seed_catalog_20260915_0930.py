...
def seed_books(apps, schema_editor):
    ...
    english, created = Language.objects.get_or_create(
        name__iexact="English", defaults={"name": "English"}
    )
    Language.objects.get_or_create(name__iexact="Español", defaults={"name": "Español"})
    Language.objects.get_or_create(name__iexact="Français", defaults={"name": "Français"})
    Language.objects.get_or_create(name__iexact="Malti", defaults={"name": "Malti"})
    Language.objects.get_or_create(name__iexact="Deutsch", defaults={"name": "Deutsch"})
    Language.objects.get_or_create(name__iexact="Italiano", defaults={"name": "Italiano"})
    Language.objects.get_or_create(name__iexact="Português", defaults={"name": "Português"})
    Language.objects.get_or_create(name__iexact="Nederlands", defaults={"name": "Nederlands"})
    Language.objects.get_or_create(name__iexact="中文", defaults={"name": "中文"})
    Language.objects.get_or_create(name__iexact="日本語", defaults={"name": "日本語"})
    Language.objects.get_or_create(name__iexact="한국어", defaults={"name": "한국어"})
    Language.objects.get_or_create(name__iexact="العربية", defaults={"name": "العربية"})
    Language.objects.get_or_create(name__iexact="हिन्दी", defaults={"name": "हिन्दी"})
    Language.objects.get_or_create(name__iexact="Polski", defaults={"name": "Polski"})
 
    history, genre_history_created = Genre.objects.get_or_create(
        name__iexact="History", defaults={"name": "History"}
    )
    computer_science, genre_computer_science_created = Genre.objects.get_or_create(
        name__iexact="Computer Science", defaults={"name": "Computer Science"}
    )
    childrens_humor, genre_childrens_humor_created = Genre.objects.get_or_create(
        name__iexact="Children's Humor", defaults={"name": "Children's Humor"}
    )
    science_fiction, genre_science_fiction_created = Genre.objects.get_or_create(
        name__iexact="Science Fiction", defaults={"name": "Science Fiction"}
    )
    graphic_novels, genre_graphic_novels_created = Genre.objects.get_or_create(
        name__iexact="Graphic Novels", defaults={"name": "Graphic Novels"}
    )
    politics, genre_politics_created = Genre.objects.get_or_create(
        name__iexact="Politics", defaults={"name": "Politics"}
    )
    food, genre_food_created = Genre.objects.get_or_create(
        name__iexact="Food Science", defaults={"name": "Food Science"}
    )
    kids, genre_kids_created = Genre.objects.get_or_create(
        name__iexact="Children's Literature", defaults={"name": "Children's Literature"}
    )
